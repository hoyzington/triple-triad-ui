...
describe('LoginComponent Test Suite', () => {
    ...
    it('Renders the login header', () => {
        ...
        // const expectedHeader = <h2>Log in to your account</h2>;

        // const wrapper = shallow(<MyComponent />);
        expect(wrapper.text().includes('Log in to your account')).toBe(true);
    ...
    //     const usernameInputWrapper = wrapper.find('input[id="username"]');
    //     const passwordInputWrapper = wrapper.find('input[id="password"]');
